...
| [`examples/wheels/`](examples/wheels/) ACME Wheels | Vehicle-fitment search filtering, lead-time and fitment disclosures, cost/margin kept off the agent surface | *(none — shopping-only)* |
